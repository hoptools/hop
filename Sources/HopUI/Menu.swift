...
/// A standard editing command. Backends map these to the platform's native edit action so they
...
/// toolkits do not. HopUI installs an equivalent standard menu bar on every backend so apps don't
